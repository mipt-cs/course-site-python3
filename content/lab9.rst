...
Для многих широко распространенных математических формул математики разработали специальную форму, которая позволяет значительно уменьшить погрешность при округлении. Например, расчет формулы «x\ :sup:`2`\ -y\ :sup:`2`\ » лучше вычислять используя формулу «(x-y)(x+y)».
...
б) посчитайте аналитически к какому значению сходится указанная последовательность. Обьясните полученный результат.
