...
begin
 ...
 for i:= 1 to r[2][0] do
     if r[2][i] mod 2 <> 1 then quit(_wa,'After all commands all discs are not on their places');
 for i:= 1 to r[3][0] do
     if r[3][i] mod 2 <> 0 then quit(_wa,'After all commands all discs are not on their places');
