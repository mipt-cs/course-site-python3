...
begin
 ...
 while not ouf.seekeof do
  ...
  if (tb=1) and (tc=3) then quit(_wa,format('Disk moving breaks the rules of the game at command #%d',[cc]));
  if (tb=2) and (tc=1) then quit(_wa,format('Disk moving breaks the rules of the game at command #%d',[cc]));
  if (tb=3) and (tc=2) then quit(_wa,format('Disk moving breaks the rules of the game at command #%d',[cc]));
