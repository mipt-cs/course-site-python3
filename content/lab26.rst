...
на вход получаю символ X, то нужно перейти в состояние B и вывести символ Y». Как следуюет из названия, конечный
...
`Машина Тьюринга`__ — абстрактный исполнитель, по сути являюющийся расширением конечного автомата. Машина Тьюринга
...
Рассмотим простейший пример одномерного клеточного автомата. Под одномерным клеточным автоматом в данном случае
понимается автомат, состоящий из клеток, выстроенных в линию. Т.е. в данном лучае у каждой клетки есть ровно два соседа:
