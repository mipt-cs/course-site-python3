...
Подсказка №2: Точки, запятые, вопросы и восклицательные знаки перед обработкой замените пробелами(используйте `str.isalpha() <https://docs.python.org/2/library/stdtypes.html#str.isalpha>`).
