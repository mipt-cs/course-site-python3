...
.. _`en-ru.txt`: {filename}/extra/lab10/task4/en-ru.txt
...
.. _`input.txt`: {filename}/extra/lab10/task4/input.txt

Упражнение №5. Сделать русско-английский словарь
------------------------------------------------

В файле `input.txt`_ находятся строки англо-русского словаря в таком формате:
